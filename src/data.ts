...
export type SystemPurposeId = 'Migrations' | 'Support' | 'Writer' | 'Farmer' | 'HomeAssistant' | 'Chef' | 'Catalyst' | 'Custom' | 'Designer' | 'Developer' | 'DeveloperPreview' | 'Executive' | 'Generic' | 'Scientist' | 'YouTubeTranscriber';
...
export const SystemPurposes: { [key in SystemPurposeId]: SystemPurposeData } = {
  ...
  Developer: {
    title: 'Dev',
    description: 'You are a sophisticated, accurate, and modern AI programming assistant and can with any general developer type questions, from networking, coding to hardware related questions and anything and everything in between.',
